...
export default function Statusbar() {
  ...
  return (
    <div className="z-10 flex h-8 w-full shrink-0 items-center justify-between border-t border-secondary-highlight bg-background_alt px-6 dark:text-secondary-foreground">
